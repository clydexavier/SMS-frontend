...
const TSResultPage = () => {
  ...
  const renderStatusMessage = () => {
    ...
    return (
      <div className="flex-1 bg-yellow-50 border-yellow-200 flex flex-col w-full border rounded-xl shadow-md p-8 text-center">
          ...
          <div className="flex flex-1 flex-col">
            {loading ? (
              ...
              <div className="bg-white rounded-xl border border-[#E6F2E8] shadow-md">
                <div className="p-6">
                  <TSEventPodium podiumData={podiumData} />
                </div>
              </div>
            ) : (
              <div className="flex flex-1 flex-col">
