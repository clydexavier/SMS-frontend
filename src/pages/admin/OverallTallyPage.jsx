  ...
  return (
    <div className="flex flex-1 flex-col w-full h-full">
        {loading ? (
          ...
          <div className="min-w-full h-full flex flex-col flex-1 bg-white p-8 rounded-xl justify-center items-center text-center shadow-sm border border-[#E6F2E8] max-w-3xl mx-auto">
            ...
            <div className="w-full h-full bg-gray-75 p-5 md:p-6 rounded-xl shadow-md border border-gray-200">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border-collapse">
                  <thead>
                    <tr className="border-b-2 border-[#E6F2E8]">
